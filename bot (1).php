...
ob_start();
$API_KEY = '5925264577:AAEqTzC0rl4zHJSY-02JGv9gAtssrhPrTqI'; //add your bot token
$sudo = 5950262907; // add your id
$bot_id = 5925264577; 
$e = "@aemn_y_bot";
...
تابع جديدنا 📮
 @am_vv12",
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [['text'=>"Add me to Your GP 🔥",'url'=>"telegram.me/aemn_y_bot?startgroup=new"]],
        [['text'=>"اضفني الى مجموعتك 🔥",'url'=>"telegram.me/aemn_y_bot?startgroup=new"]],
...
'disable_web_page_preview'=>true,
   ...
   if($text=="/help" or $text=="/help@aemn_y_bot" or $text=="الاوامر"){
    bot('sendMessage',[
        'chat_id'=>$chat_id,
...
if($text == "شلونكم" or $text == "كيفك" or $text == "شحالك" or text == "وشحالك" or $text == "وشحالك" or $text == " or $text == "شلونك" or $text == "شلونج"){
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"تمام ونته/ي 😻🌸",
'reply_to_message_id'=>$message->message_id, 
